...
stringConstants = {
    ...
    'initiatingSpatialCollapse': 'We are initiating a purge of the entire quadrant',
    'habitatsDestroyed': 'All civilian population lost',
    'anomaliesEliminated': 'All anomalies resolved',
    'friendlyFire': 'Records show you fired on civilian population',
    'huntersDispatched': 'You are to be relieved of command',
    'noAmmo': 'You are to be relieved of command',
